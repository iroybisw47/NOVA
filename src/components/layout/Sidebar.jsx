...
const navItems = [
  ...
  { id: 'sessions', label: 'Sessions', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar__brand">
        ...
        <span className="sidebar__title">Nova</span>
      </div>
      ...
      <nav className="sidebar__nav">
        {navItems.map(item => (
          <button
            ...
            className={`sidebar__nav-item ${currentTab === item.id ? 'sidebar__nav-item--active' : ''}`}
          >
